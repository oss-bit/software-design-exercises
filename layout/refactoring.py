# GVW: you'll notice that I put two blank lines between class and
# function definitions (but only one blank line between method
# definitions). This is more-or-less standard Python style; if you
# want, you can `pip install ruff` and then run `ruff check .` or
# something similar to check style. `ruff check --fix .` will both
# check style and do simple repairs.
...
# GVW: good - this is a good way to force people to implement these
# methods.  Another is https://docs.python.org/3/library/abc.html and
# the @abstractmethod decorator - I have no preference either way.
